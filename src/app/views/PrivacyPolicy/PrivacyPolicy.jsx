  ...
  render() {
    return (
      <div className="pb-5">
        ...
        <div className="row">
          <div className="col-md-12">
            <p>This privacy policy describes how our service collects, protects and uses the personally identifiable information you may provide on the blank to our website and any of its products or services. It also describes the choices available to you regarding our use of your personal information and how you can access and update this information. This Policy does not apply to the practices of companies that we do not own or control, or to individuals that we do not employ or manage.</p>
            ...
            <p>If you have any questions about this Policy, please contact us at belizecommerce@gmail.com or give us a call at 501-608-2077.</p>

            <p className="text-muted">This document was last updated on October 1, 2018</p>
          </div>
        </div>
      </div>
    );
